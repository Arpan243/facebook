...
class Profile(models.Model):
    ...
    cover_image = models.ImageField(upload_to=user_directory_path,blank=True,default="cover.jpg")
    image = models.ImageField(upload_to=user_directory_path,blank=True,default="default.jpg")
    full_name = models.CharField(max_length=200,null=True,blank=True)
    phone = models.CharField(max_length=20,null=True,blank=True)
    gender = models.CharField( max_length=50, choices=GENDER, default="male")
    relationship = models.CharField( max_length=50, choices=RELATIONSHIP, default="single")
    ...
    working_at = models.CharField( max_length=500,null=True,blank=True)
