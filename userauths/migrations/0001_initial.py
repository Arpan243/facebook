    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_image', models.ImageField(blank=True, default='cover.jpg', upload_to=userauths.models.user_directory_path)),
                ('image', models.ImageField(blank=True, default='default.jpg', upload_to=userauths.models.user_directory_path)),
                ('full_name', models.CharField(blank=True, max_length=200, null=True)),
                ('phone', models.CharField(blank=True, max_length=20, null=True)),
                ('gender', models.CharField(choices=[('male', 'Male'), ('female', 'Female'), ('others', 'Others')], default='male', max_length=50)),
                ('relationship', models.CharField(choices=[('single', 'Single'), ('in a relationship', 'In a RelationShip'), ('it is complex', "It's Complex")], default='single', max_length=50)),
                ...
                ('working_at', models.CharField(blank=True, max_length=500, null=True)),
